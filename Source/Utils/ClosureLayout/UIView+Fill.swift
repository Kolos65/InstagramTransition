...
extension UIView {
    @discardableResult
    public func fillWith(_ view: UIView, insets: UIEdgeInsets? = nil) -> (top: NSLayoutConstraint, bottom: NSLayoutConstraint, leading: NSLayoutConstraint, trailing: NSLayoutConstraint) {
